...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Spring Boot使用Swagger2构建RESTful API").description("rest api文档构建利器")
                .termsOfServiceUrl("https://wwww.google.com")
                .contact(new Contact("jc feng", "https://github.com/SCUTJcfeng", "jcfeng2013@gmail.com")).version("1.0")
                .build();
    }
}